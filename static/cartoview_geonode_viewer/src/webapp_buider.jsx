...
class CartoviewViewer extends React.Component {
  ...
  render() {
    ...
    const layerSwitcher = appConfig.showLayerSwitcher
      ? <LayerList allowFiltering={true} showOpacity={true} allowStyling={true} downloadFormat={'GPX'} showDownload={true} allowRemove={false} showGroupContent={true} showZoomTo={true} allowLabeling={true} allowEditing={true} allowReordering={true} showTable={true} handleResolutionChange={true} includeLegend={appConfig.showLegend} map={map}/>
      : '';
    ...
    const geocoding_paper = appConfig.showGeoCoding
      ? <Paper id="geocoding_paper" zDepth={3}><Geocoding maxResult={5}/><GeocodingResults map={map}/></Paper>
      : "";
